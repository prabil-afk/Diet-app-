...
class _HomePage extends State<HomePage> with TickerProviderStateMixin {
  ...
  Color selectedItemsColors = Colors.black26;
  ...
  void _selectedTab(int index) {
    ...
    setState(() {
      ...
      if (_selectedIndex == 4) {
        selectedItemsColors = Colors.black;
      } else {
        selectedItemsColors = Colors.black;
      }
    });
              ...
              bottomNavigationBar: Visibility(
                ...
                child: ColoredBox(
                  ...
                  child: FABBottomAppBar(
                    ...
                    color: Color.fromARGB(153, 245, 243, 243),
                    ...
                    items: [
                      ...
                      FABBottomAppBarItem(
                          iconData: Icons.medical_services, text: "Diet Plan"),
